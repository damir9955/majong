 ...
 *
 * ЗНАКИ: из девяти иероглифов оставлены только сильно различающиеся
 * 五六七八九 — похожие «полоски» 一二三 и «коробка» 四 (путалась с
 * ветром 西) убраны: игрок больше не тапает по «почти такой же» кости.
 * Всего 38 видов → 76 пар одинаковых картинок (доске нужно ≤ 40).
 */
...
/**
 * Полная колода как 76 «пар»: каждый из 38 видов плиток имеет
 * 4 физические копии → 2 пары одинаковых картинок (76 пар = 152 места,
