/**
 * Классический набор плиток маджонга (144 штуки) + метаданные для отрисовки.
 */
...
/**
 * Полная колода как 84 «пары»: каждый из 42 видов плиток имеет
 * 4 физические копии → 2 пары одинаковых картинок (84 пары = 168 мест,
 * доска максимум 144 плитки). Совпадают только ОДИНАКОВЫЕ картинки —
 * как в популярных играх из Play Market.
 */
