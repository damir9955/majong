...
const RU: Record<string, string> = {
  ...
  'home.onlineSub': 'Комната по коду · по ссылке',
  ...
  'room.codeTitle': 'Код комнаты',
  'room.waiting': 'Ждём друга…',
  'room.waitingHint': 'Отправь другу код или ссылку — он введёт его в разделе «С другом»',
  'room.copyLink': 'Ссылка',
  'room.copyCode': 'Код',
  ...
  'room.notFound': 'Комната не найдена — проверь код',
  'room.full': 'Комната уже занята',
  'room.network': 'Нет связи — попробуй ещё раз',
  'room.lost': 'Комната больше не существует',
  'room.closed': 'Комната закрыта — матч прерван',
...
const EN: Record<string, string> = {
  ...
  'home.onlineSub': 'Room by code · by link',
  ...
  'room.codeTitle': 'Room code',
  'room.waiting': 'Waiting for a friend…',
  'room.waitingHint': 'Send your friend the code or link — they will enter it in the "With a friend" section',
  'room.copyLink': 'Link',
  'room.copyCode': 'Code',
  ...
  'room.notFound': 'Room not found — check the code',
  'room.full': 'This room is already taken',
  'room.network': 'No connection — try again',
  'room.lost': 'This room no longer exists',
  'room.closed': 'Room closed — match interrupted',
